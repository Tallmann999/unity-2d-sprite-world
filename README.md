...
Вторая реализация — просёлочная дорога с плавными поворотами, подъёмами и спусками, густой растительностью и лёгким средневековым настроением. Её игровое изображение рендерится в **256 × 256 пикселей**.
...
3. Откройте `Assets/Scenes/Scene1_Dungeon.unity` для подземелья или `Assets/Scenes/CountryRoad256.unity` для дороги.
